class Calculator {
    // constructor method DOM elements
...
constructor() {
    ...
    //Define the method to clear calculator
    ...
    //Define method to delete the last digit from the current operand
...
calculator.clearButton.addEventListener("click", () => {
  ...
  //====== new event listener square root 
  calculator.squareButton.addEventListener("click", () => {
